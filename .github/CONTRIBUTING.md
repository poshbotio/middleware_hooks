# How to contribute
Contributions to `middleware_hooks` are highly encouraged and desired. Below are some guidelines that will help make the process as smooth as possible.
...
I want to know what you think is missing from `middleware_hooks` and how it can be made better.
